...
(function($){
  ...
  function toggleSelected(element, shouldSelect) {
    ...
    $(element).parents("td").toggleClass("selected", shouldSelect);
  }
  
    $("#monthsList table").find(":checkbox").live("click", function(event) {
		$table = $("#monthsList table");
      var last = $table.data("jquery-shift-select-taaaable.last");
      $table.data("jquery-shift-select-taaaable.last", $(this).get());
  ...
  $.fn.shiftSelectTable = function(){
    ...
    this.find(":checked").parents("td").toggleClass("selected");
