  ...
  scrollbarPaper: function() {
    this.each(function(i) {
      ...
      if (ratio < 1) {
        ...
        paper.show();
        content.parent().addClass('scrollbarpaper-active');
        ...
        $this.unbind();
        paper.hide();
        content.parent().removeClass('scrollbarpaper-active');
